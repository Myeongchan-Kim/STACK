...
/*
	...
	The buffer usage needs to be set to dynamic since we will be updating it each frame.The bind flags indicate that this buffer will be a constant buffer.
